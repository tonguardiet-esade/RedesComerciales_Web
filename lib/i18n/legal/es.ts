...
export const esLegalContent: LegalSiteContent = {
  privacy: [
    {
      type: 'p',
      text:
        'Redescomerciales.ai para proteger los derechos individuales, especialmente en relación con el tratamiento automatizado y con la intención de ser transparentes con el Usuario, ha establecido una política que incluye todos esos tratamientos, las finalidades perseguidas por los mismos, la legitimidad de los mismos y también los instrumentos disponibles para el Usuario para que pueda ejercer sus derechos.',
    },
    {
      type: 'p',
      text:
    ...
    { type: 'h2', text: 'Recopilación de datos' },
    { type: 'p', text: 'Sus datos son recopilados por el PROPIETARIO.' },
    {
      type: 'p',
      text:
    ...
    { type: 'h2', text: '¿Con qué finalidad se tratan sus datos personales?' },
    {
      type: 'p',
      text:
    ...
    { type: 'h2', text: '¿Cuál es la legitimidad del tratamiento de sus datos?' },
    { type: 'p', text: 'La base legal para el tratamiento de sus datos personales es:' },
    {
      type: 'ul',
      items: [
    ...
    { type: 'h2', text: '¿A qué destinatarios se comunicarán los datos?' },
    {
      type: 'p',
      text:
    ...
    { type: 'p', text: 'Para obtener más información, consulte nuestra política de cookies.' },
    { type: 'h2', text: 'Derechos de usuario' },
    {
      type: 'p',
      text:
    ...
    {
      type: 'p',
      text: 'La solicitud también puede enviarse al siguiente correo electrónico: info@redescomerciales.ai.',
    },
    {
      type: 'p',
      text:
  ...
  cookies: [
    ...
    {
      type: 'p',
      text: 'Al navegar por primera vez, aparecerá un banner que explica el uso de cookies.',
    },
    { type: 'h2', text: '3. Tipos y finalidad de las cookies' },
    {
      type: 'p',
      text: 'Las cookies, según su permanencia, se pueden clasificar de la siguiente manera:',
    },
    {
      type: 'ul',
      items: [
        { strong: 'Cookies de sesión:', text: ' caducan cuando el usuario cierra el navegador.' },
        {
          strong: 'Cookies persistentes:',
          text:
            ' caducan cuando se cumple la finalidad para la que se utilizan (por ejemplo, para que el usuario permanezca identificado en el sitio web y sus servicios o cuando se eliminan manualmente).',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        {
          strong: 'Cookies necesarias:',
          text:
            ' son imprescindibles para habilitar las funciones básicas de este sitio, como el inicio de sesión seguro o la gestión de sus preferencias de consentimiento. Estas cookies no almacenan ningún dato que permita identificarle personalmente.',
        },
        {
          strong: 'Cookies funcionales:',
          text:
            ' ayudan a realizar ciertas funciones, como compartir el contenido del sitio web en plataformas de redes sociales, recopilar comentarios y otras funciones de terceros.',
        },
        {
          strong: 'Cookies analíticas:',
          text:
            ' se utilizan para comprender cómo interactúan los visitantes con el sitio web. Estas cookies ayudan a proporcionar información sobre métricas como el número de visitantes, la tasa de rebote, la fuente de tráfico, etc.',
        },
        {
          strong: 'Cookies publicitarias:',
          text:
            ' se utilizan para ofrecer a los visitantes anuncios personalizados basados en las páginas que han visitado anteriormente y para analizar la eficacia de las campañas publicitarias.',
        },
      ],
    },
    { type: 'h2', text: '4. Cómo bloquear o eliminar las cookies instaladas' },
    {
      type: 'links',
      intro:
    ...
    },
    {
      type: 'links',
      intro:
        'Todo lo relacionado con las cookies de Google, tanto analíticas como publicitarias, así como su gestión y configuración, puede consultarse en:',
      items: [
        {
          label: 'Tipos de cookies de Google',
          href: 'https://www.google.es/intl/es/policies/technologies/types/',
        },
        {
          label: 'Publicidad de Google',
          href: 'https://www.google.es/policies/technologies/ads/',
        },
        {
          label: 'Uso de cookies de Google Analytics',
  ...
  legal: [
    { type: 'h2', text: 'Datos de identificación' },
    {
      type: 'p',
      text:
    ...
    {
      type: 'p',
      text: 'Esta actividad no está sujeta a ningún régimen de autorización administrativa previa.',
    },
    {
      type: 'p',
      text: 'Puede ponerse en contacto con Redescomerciales.ai por cualquiera de los siguientes medios:',
    },
    {
      type: 'ul',
      items: [
    ...
    { type: 'h2', text: 'Alojamiento web' },
    { type: 'p', text: 'Webempresa Europa SL' },
    { type: 'p', text: 'Calle Almagro, 11, Madrid, 28010, Madrid.' },
    { type: 'p', text: 'Teléfono: 910912834.' },
    { type: 'p', text: 'Correo electrónico de contacto: comercial@webempresa.com.' },
    { type: 'h2', text: 'Usuarios' },
    {
      type: 'p',
      text:
    ...
    { type: 'h2', text: 'Utilizando el portal' },
    {
      type: 'p',
      text:
    ...
    },
    {
      ...
      items: [
        ...
        'Causar daños a los sistemas físicos y lógicos de Redescomerciales.ai, sus proveedores o terceros, introducir o propagar virus informáticos o cualquier otro sistema físico o lógico que pueda causar los daños mencionados.',
        ...
        'No utilice el sitio web ni la información contenida en él con fines comerciales, políticos, publicitarios ni para ningún otro uso comercial, especialmente para el envío de correos electrónicos no solicitados.',
      ],
    },
    {
      type: 'p',
    ...
    { type: 'h2', text: 'Protección de datos' },
    {
      type: 'p',
      text:
        '4. Todo lo relacionado con la política de protección de datos está contenido en el documento de política de privacidad.',
    },
    { type: 'h2', text: 'Contenido. Propiedad intelectual e industrial' },
    {
      type: 'p',
      text:
    ...
    { type: 'h2', text: 'Exclusión de garantías y responsabilidad' },
    {
      type: 'p',
      text:
    ...
    },
    {
      type: 'ul',
      items: [
        'a) La disponibilidad en el funcionamiento del sitio web, sus servicios y contenidos y su calidad o interoperabilidad.',
        'b) La finalidad para la que el sitio web sirve a los objetivos del USUARIO.',
        'c) La infracción de la legislación vigente por parte del USUARIO o de terceros y, específicamente, de los derechos de propiedad intelectual o industrial que sean propiedad de otras personas o entidades.',
        'd) La existencia de códigos maliciosos o cualquier otro elemento informático dañino que pudiera causar daños al sistema informático del USUARIO o de terceros. Es responsabilidad del USUARIO, en todo caso, disponer de las herramientas adecuadas para la detección y desinfección de dichos elementos.',
        'e) El acceso fraudulento a los contenidos o servicios por parte de terceros no autorizados o, en su caso, la captura, eliminación, alteración, modificación o manipulación de mensajes y comunicaciones de cualquier tipo que dichos terceros puedan realizar.',
        'f) La exactitud, veracidad, actualidad y utilidad de los contenidos y servicios ofrecidos y el uso posterior que el USUARIO haga de ellos. Redescomerciales.ai empleará todos los medios y esfuerzos razonables para proporcionar información actualizada y fiable.',
        'g) Daños causados a los equipos informáticos durante el acceso al sitio web y daños causados a los USUARIOS cuando tengan su origen en fallas o desconexiones en las redes de telecomunicaciones que interrumpan el servicio.',
        'h) Daños derivados de circunstancias resultantes de un caso fortuito o de fuerza mayor.',
      ],
    },
    {
      type: 'p',
    ...
    { type: 'h2', text: 'Modificación de este aviso legal y duración' },
    {
      type: 'p',
      text:
    ...
    { type: 'h2', text: 'Ley aplicable y jurisdicción' },
    {
      type: 'p',
      text:
  ...
  cookieList: {
    ...
    intro:
      'Además de las cookies recogidas en las tablas siguientes, este sitio puede utilizar almacenamiento local del navegador (por ejemplo, gw_lang, gw_theme) para recordar preferencias de idioma y tema visual.',
    tableHeaders: {
      name: 'Cookie',
      duration: 'Duración',
      description: 'Descripción',
    },
    emptyMessage: 'Actualmente este sitio web no utiliza cookies de este tipo.',
    categories: [
      {
        id: 'necessary',
        title: 'Necesarias',
